...
def cluster_decoder(HGP_code,E_index_set,s_index_set):
    ...
    for comp_index in range(num_comps):
        ...
        # Update the maximum component size if this component is larger.
        if (len(comp_E_index_set) > max_comp_size):
            max_comp_size = len(comp_E_index_set)
    ...
    return predicted_e_index_set, max_comp_size
...
def combined_peeling_and_cluster_decoder(HGP_code,E_index_set_input,s_index_set_input):
    ...
    global_cluster_only_max_comp_size = 0
    ...
    while (s_index_set != set()):
        ...
        if (set_of_dangling_check_indices != set()):
            ...
            try:
                cluster_decoder_pred_e_index_set, max_comp_size = cluster_decoder(HGP_code,E_index_set,s_index_set)
                if (global_max_comp_size < max_comp_size):
                    global_max_comp_size = max_comp_size
        ...
        _, cluster_only_max_comp_size = cluster_decoder(HGP_code,E_index_set,s_index_set)
        if (global_cluster_only_max_comp_size < cluster_only_max_comp_size):
            global_cluster_only_max_comp_size = cluster_only_max_comp_size
    ...
    combined_decoder_results_dict['cluster_only_decoder_max_component_size'] = global_cluster_only_max_comp_size
...
def combined_peeling_cluster_decoder_simulation(HGP_code,num_iterations,erasure_rate):
    ...
    max_comp_size_list = []
    cluster_only_max_comp_size_list = []
    ...
    progress_count = int(num_iterations/10)
    ...
    for iterations in range(num_iterations):
        ...
        try:
            ...
            if (combined_decoder_results_dict['cluster_only_decoder_max_component_size'] > 0):
                cluster_only_max_comp_size_list.append(combined_decoder_results_dict['cluster_only_decoder_max_component_size'])
    ...
    #print(cluster_only_max_comp_size_list)
    simulation_results_dict['max_cluster_only_max_component_size'] = max(cluster_only_max_comp_size_list) if cluster_only_max_comp_size_list else 0
    simulation_results_dict['average_cluster_only_max_component_size'] = sum(cluster_only_max_comp_size_list)/float(len(cluster_only_max_comp_size_list)) if cluster_only_max_comp_size_list else 0.0
    simulation_results_dict['std_cluster_only_max_component_size'] = (sum([(x - simulation_results_dict['average_cluster_only_max_component_size'])**2 for x in cluster_only_max_comp_size_list])/float(len(cluster_only_max_comp_size_list)))**0.5 if cluster_only_max_comp_size_list else 0.0
...
def main():
    ...
    num_trials = 5000 #25000
    step = 32

    # 625 qubit PEG code
    C_625 = construct_HGP_code_from_classical_H_text_file('PEG_HGP_code_(3,4)_family_n625_k25_classicalH.txt')
    C_625_perf_dict_list = run_combined_peeling_cluster_decoder_varying_erasure_rate(C_625,0.32,step,num_trials)
    ...
    C_1225_perf_dict_list = run_combined_peeling_cluster_decoder_varying_erasure_rate(C_1225,0.32,step,num_trials)
    ...
    C_1600_perf_dict_list = run_combined_peeling_cluster_decoder_varying_erasure_rate(C_1600,0.32,step,num_trials)
    ...
    C_2025_perf_dict_list = run_combined_peeling_cluster_decoder_varying_erasure_rate(C_2025,0.32,step,num_trials)
